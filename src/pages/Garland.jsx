      ...
      <section className="bg-orange-50/95 backdrop-blur-sm py-12 px-4">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-6">
            🙏 Jai Sri Ram!
                <br />
             Welcome to Sri Bhaktha Hanuman Temple Fresh Garland Order Booking
            🙏
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm shadow-xl rounded-lg p-1 md:p-2">
              <iframe
                src="https://docs.google.com/forms/d/e/1FAIpQLSerO-ajSrUfixouOgwZdT7g8qPbU81ePZtg54WUxTTfGgns5w/viewform?embedded=true"
                width="100%"
                height="1500"
                frameBorder="0"
                marginHeight="0"
